# -*- coding: utf-8 -*-
"""
Created on Sun Jun 20 11:54:31 2021
...
#Import data 
HR_data = pd.read_csv("C:/Users/nisht/Desktop/CPBA/live project/HR_Data.csv")
HR_data.head(5)
HR_data.tail(5)
...
sns.countplot(x="left",hue="Work_accident",data=HR_data)
...
HR_data = pd.concat([HR_data,Salary_Dummy],axis=1)
HR_data.head(5)
...
#Hence, accuracy = (2658+301)\(2658+223+568+301) = 78.9%
...
#Survived = 
#exp(-0.514 -4.17*Satisfaction_level -0.42*last_evaluation -0.3*number_project -0.0046*average_monthly hours +0.25*exp_in_company -
#-1.27*work_accident-0.855*promotion_last_5years + 1.629*salary(low) + 1.098*salary(medium)
# \
#exp(-0.514 -4.17*Satisfaction_level -0.42*last_evaluation -0.3*number_project -0.0046*average_monthly hours +0.25*exp_in_company -
#-1.27*work_accident-0.855*promotion_last_5years + 1.629*salary(low) + 1.098*salary(medium))+1